(function (global, factory) {
  ...
  function loadComponents() {
    document.querySelectorAll("[vi-data]").forEach(function (element, key) {
      var parentVueNode = element.parentNode.closest("[vi-data]");

      if (parentVueNode == null) {
        return;
      }

      var dataAttr = element.getAttribute("vi-data");
      var dataExpression = dataAttr === "" ? "{}" : dataAttr;
      element.removeAttribute("vi-data");
      var propsAttr = element.getAttribute("vi-props");
      var propsExpression = propsAttr === "" ? "{}" : propsAttr;
      var name = element.getAttribute("vi-name");
      var tag = "vi-data-".concat(v4());
      Vue__default['default'].component(tag, {
        name: name || tag,
